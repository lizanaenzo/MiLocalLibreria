...
class CreatePersona(CreateView):
    ...
    template_name = 'admin/crear_persona.html'
    success_url = reverse_lazy('inicio')

class ListPersona(ListView):
    model = DatosPersona
    template_name = 'admin/listar_persona.html'
...
class DeletePersona(DeleteView):
    model = DatosPersona
    template_name = 'admin/eliminar_persona.html'
    success_url = reverse_lazy('inicio')
...
def crearPersona(request):
    ...
    return render(request, 'admin/crear_persona.html', {'form':form})

def listarPersona(request):
    persona = DatosPersona.objects.all()
    context = {'persona':persona}
    return render(request,'admin/listar_persona.html',context)
...
def eliminarPersona(request,id):
    ...
    if request.method == 'POST':
        persona.delete()
        return redirect('inicio')
    return render(request,'admin/eliminar_persona.html',{'persona':persona})